...
export async function GET(request: NextRequest) {
  try {
    ...
    // URL da API do Pixeldrain para listar arquivos
    const apiUrl = 'https://pixeldrain.com/api/user/files';
    
    console.log('Fazendo requisição para a API do Pixeldrain (files)...');
    ...
    console.log('Resposta da API do Pixeldrain (files) recebida com sucesso');
